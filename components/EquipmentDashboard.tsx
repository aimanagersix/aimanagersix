...
const SortableHeader: React.FC<{
    sortKey: string;
    title: string;
    sortConfig: { key: string; direction: 'ascending' | 'descending' } | undefined;
      ...
      <div className="overflow-x-auto min-h-[400px]">
        {loading ? (
            ...
            <thead className="text-xs text-on-surface-dark-secondary bg-gray-700/50">
                ...
                <SortableHeader sortKey="description" title="Equipamento" sortConfig={sort} requestSort={requestSort} />
                    ...
                    >
                        ...
                        <td className="px-6 py-4" onClick={(e) => e.stopPropagation()}>
                             <select
                                ...
                                className={`px-2 py-1 rounded-md text-xs font-bold border focus:outline-none focus:ring-2 focus:ring-brand-secondary cursor-pointer ${customColor ? 'border-transparent' : getStatusClass(item.status)}`}
