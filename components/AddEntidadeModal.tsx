            ...
            <form onSubmit={handleSubmit} className="space-y-6 overflow-y-auto max-h-[80vh] pr-2 custom-scrollbar p-1">
                ...
                <div className="bg-gray-800/20 p-6 rounded-xl border border-gray-700 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea value={formData.description} onChange={e => setFormData({...formData, description: e.target.value})} className="w-full bg-gray-700 border border-gray-600 text-white rounded p-2 text-sm focus:border-brand-primary outline-none" rows={2} placeholder="Breve descrição da atividade ou finalidade deste local..."></textarea>
                    </div>
                </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <div className="sm:col-span-1">
                                <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Fixo</label>
                            ...
                            <div className="sm:col-span-1">
                                <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Móvel</label>
                            ...
                            <div className="sm:col-span-1">
                                <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Extensão</label>
                                <input type="text" value={formData.telefone_interno} onChange={e => setFormData({...formData, telefone_interno: e.target.value})} className="w-full bg-gray-700 border border-gray-600 text-white rounded p-2 text-sm" placeholder="Ext. 123" />
                            </div>
                        </div>
                    </div>
