        ...
        <div className="relative" ref={menuRef}>
            <button onClick={() => setIsOpen(!isOpen)} className="flex items-center gap-3 p-2 rounded-md hover:bg-gray-800 transition-colors w-full">
                {currentUser.photoUrl ? (
                    ...
                    <div className="h-8 w-8 rounded-full bg-brand-secondary flex items-center justify-center font-bold text-white text-xs flex-shrink-0">{currentUser.fullName.charAt(0)}</div>
                )}
